package com.kleinreveche.playground.core.helpers
...
object PreferenceHelper {
    ...
    fun checkForPrefs(key: String, defaultValue: Any) {
...
fun rememberBooleanPreference(
    ...
    val state = remember {
        mutableStateOf(PreferenceHelper.get(key, default))
    }
    DisposableEffect(Unit) {
        ...
        PreferenceHelper.getPreferences.registerOnSharedPreferenceChangeListener(listener)
        onDispose {
            PreferenceHelper.getPreferences.unregisterOnSharedPreferenceChangeListener(listener)
        }
    }
