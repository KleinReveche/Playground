...
fun Display(viewModel: TimerViewModel, modifier: Modifier = Modifier) {
    BoxWithConstraints(modifier, Alignment.Center) {
        val digitsColor by animateColorAsState(MaterialTheme.colorScheme.primary)
        val separatorsColor by animateColorAsState(MaterialTheme.colorScheme.onBackground)
